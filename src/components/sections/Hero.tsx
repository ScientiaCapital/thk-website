    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-[850px] mx-auto px-6 py-32 text-center">
        ...
        <Badge variant="live" className="mb-6">
          ...
          Now offering Managed AV Infrastructure
        </Badge>
        ...
        <h1 className="text-[clamp(2.2rem,5.5vw,3.6rem)] font-extrabold leading-[1.1] tracking-tight mb-6 font-display">
          ...
          <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
            video cameras and AI
          </span>{' '}
          in schools and churches so they{' '}
          <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
            never miss
          </span>{' '}
          a recording again
        ...
        <p className="text-lg text-slate-400 max-w-[650px] mx-auto mb-10 leading-relaxed">
          THK deploys professional Epiphan Pearl encoders at your location and manages them 24/7 from Mexico City.
          Zero on-site technicians. $50-75/month per device instead of $50,000 for a full-time AV tech.
        </p>

        {/* CTA buttons */}
        <div className="flex flex-wrap gap-4 justify-center">
          <Button size="lg">
            Explore Managed AV <ArrowRight className="w-4 h-4" />
          </Button>
